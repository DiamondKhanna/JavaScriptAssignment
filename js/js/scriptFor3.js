...
headings[1]="Growth in Purchasing Power (2010-2013)";
headings[2]="Growth in Population (2010-2013)";
...
for(var i = 1; i < (rows.length-3); i++)
{
	...
	final_object[headings[2]]=(row_at_a_time[5]-row_at_a_time[2]).toString();
